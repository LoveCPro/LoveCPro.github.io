...
![](https://github.com/LoveCPro/LoveCPro.github.io/blob/master/img/readme_about.jpg)
...
>
### [查看博客戳这里 👆](http://LoveCPro.github.io)
...
看右边:
![](https://github.com/LoveCPro/LoveCPro.github.io/blob/master/img/readme-side.jpg)
...
我的博客标题是 **“DAN Blog”** 但是我想要在搜索的时候显示 **“丹丹的博客 | DAN Blog”** ，这个就需要 SEO Title 来定义了。
...
遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/LoveCPro/LoveCPro.github.io/blob/master/LICENSE)。
